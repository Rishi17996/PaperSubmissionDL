...
// 			prepared statement
            ...
            if(checkInteger(stringList.get(i))) {
               preparedStmt.setInt(i + 1, Integer.parseInt(stringList.get(i)));
            }
            else {
	...
	public ArrayList<ArrayList<String>> getData(String sqlString, List<String> stringList) {      
		// create prepared statement
		// with sql string
